...
<form action="" method="post" style="float: right; background-color:#D0D3D4;padding: 1%;margin: 5%;" >
	...
	<div>
		...
		<b style="margin-right: 16%" id="t2" register>Email:</b><br>
			...
			<input type="text" name="email" placeholder="@gmail.com"; style="width: 27%;padding:10px">

			<br>
		<b style=" margin-right: 07%"><a>i prefer to use my current email address</a></b><br><br>
		<b style="margin-right:19%" id="t3" register>Create a password</b><br>
			<input type="password"  name="pass" placeholder="more than 8 characters" style="width: 27%;padding: 10px"><br><br>
		...
		<b style="margin-right: 25%" id="t6" register>Gender</b><br>
			<select style="width:29%; padding:10px;" name="gender">
		...
		<b style="margin-right: 25%" id="t9" register>Location</b><br>
			...
			<input type="submit" name="next step"  value="next step" style="background-color: blue;color: white; width:30%; padding: 10px" ></b>
	</div>
</center>
</form>
